...
public class ConfigurationData {
	public static String PROJECT_NAME = "TrafficLight";
	
	public static String MESSAGES_FILE = "data/" + PROJECT_NAME + "/Messages.txt";
	
	public static String FSM_FILE = 
			//"data/" + PROJECT_NAME +"/FSM_Model_ONLY_CONSTRAINT2.sm";
			"data/" + PROJECT_NAME +"/TrafficLight_Complete.sm";
	
	public static String SCA_FILE = 
			"data/" + PROJECT_NAME +"/SCA.txt";
	
	public static boolean LOAD_SCA=false;
	...
	public static Strength TEST_STRENGHT = Strength.PAIR_WISE;
